...
export const PROMPT_TYPES = [
    ...
    {prompt: PROMPT_CANDIDATES[3], type: 1},
    {prompt: PROMPT_CANDIDATES[4], type: 1},
    {prompt: PROMPT_CANDIDATES[5], type: 1},
    {prompt: PROMPT_CANDIDATES[6], type: 0},
    {prompt: PROMPT_CANDIDATES[7], type: 0},
    {prompt: PROMPT_CANDIDATES[8], type: 0},
]
